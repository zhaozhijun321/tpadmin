    ...
    var Controller = {
                    ...
                    [
                        ...
                        },
                        {
                            field: 'title', title: __('Title'), align: 'left', formatter: function (value, row, index) {
                                return '<div class="tdtitle"><a href="' + row.url.replace('/asd.php/','/') + '" target="_blank">' + value + '</a></div>' + Table.api.formatter.flag.call(this, row['flag'], row, index);
                            }
                        },
        ...
        add: function () {
            ...
            $("#c-channel_id").trigger("change");
                  //课程专家筛选
            $(document).on('change','#zhuanjiaid',function(){
                var index = $(this).selectedIndex; 
                 var expertsname = $(this).find("option:selected").text()
                    $('#c-experts').val(expertsname)
            })
