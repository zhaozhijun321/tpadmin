<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/show_zhuanjia.html";i:1555598854;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__y2E1O9TiQS__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__y2E1O9TiQS__) || $__y2E1O9TiQS__ instanceof \think\Collection || $__y2E1O9TiQS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__y2E1O9TiQS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__qygaVWcoNh__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__qygaVWcoNh__) || $__qygaVWcoNh__ instanceof \think\Collection || $__qygaVWcoNh__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__qygaVWcoNh__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__aHjDzY4JPs__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__aHjDzY4JPs__) || $__aHjDzY4JPs__ instanceof \think\Collection || $__aHjDzY4JPs__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__aHjDzY4JPs__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
...
<div class="n-detail">
    <!-- 左侧标准详情盒子部分 -->
    <div class="n-box-left teachers">
        <!-- 详情标题 -->
        <!-- <h2><?php echo $__ARCHIVES__->title; ?></h2>
        <div class="shares">
            <p class="time"><?php echo date('Y.m.d',$__ARCHIVES__->createtime); ?></p>
        ...
        <div class="teacher-img">
            <img src="<?php echo $__ARCHIVES__->image; ?>" alt="">
        </div>
        <!-- 专家详情 -->
        <div class="detail-cont teachers-cont">
            <!-- 只是为了样式,详情正文不用放在P标签中 -->
    ...
    <div class="t-right ">
        ...
        <div class="n-box-right">
            <a href="<?php echo $__CHANNEL__->url; ?>">
                <h2>推荐<?php echo $__CHANNEL__->name; ?>
                <img src=" /assets/addons/cms/src/image/more2.png" alt="" class="icons">
            </h2>
            </a>
            <!-- 右侧分类集合 -->
            <div class="t-list">
                <!-- 右侧小分类 -->
                <?php $__v8oj3kGw2n__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","row"=>"4","orderby"=>"weigh,publishtime","orderway"=>"asc","tags"=>$__ARCHIVES__->tags]); if(is_array($__v8oj3kGw2n__) || $__v8oj3kGw2n__ instanceof \think\Collection || $__v8oj3kGw2n__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__v8oj3kGw2n__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($item['id']==$__ARCHIVES__->id): else: ?>
        ...
        <!-- 主讲课程 -->
        <div class="n-box-right" style="margin-top:50px">
            <a href="/cms/c/chanpinyufuw">
                <h2>主讲课程
                <img src=" /assets/addons/cms/src/image/more2.png" alt="" class="icons">
                </h2>
            </a>
            ...
            <div class="list">
                <!-- 右侧小分类 -->
                <?php $list =\addons\cms\model\Archives::getzhujia(['row'=>2,'expert'=>$__ARCHIVES__->id]); if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$item): ?>
                <!-- <a href="<?php echo $item->url; ?>"> -->
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__WVG6ywsevt__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__WVG6ywsevt__) || $__WVG6ywsevt__ instanceof \think\Collection || $__WVG6ywsevt__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__WVG6ywsevt__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__R3my0TNVj7__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__R3my0TNVj7__) || $__R3my0TNVj7__ instanceof \think\Collection || $__R3my0TNVj7__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__R3my0TNVj7__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
