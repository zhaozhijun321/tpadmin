<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/formfield.html";i:1549411004;s:70:"/www/wwwroot/default/tpadmin/addons/cms/view/default/list_chanpin.html";i:1555598393;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__YyHXGoW8gP__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__YyHXGoW8gP__) || $__YyHXGoW8gP__ instanceof \think\Collection || $__YyHXGoW8gP__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__YyHXGoW8gP__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__V6x7oeD30i__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__V6x7oeD30i__) || $__V6x7oeD30i__ instanceof \think\Collection || $__V6x7oeD30i__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__V6x7oeD30i__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__cDqwmpg3PH__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__cDqwmpg3PH__) || $__cDqwmpg3PH__ instanceof \think\Collection || $__cDqwmpg3PH__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__cDqwmpg3PH__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
...
<style type="text/css">
 ...
 <div class="cont-box">
             ...
             <ul class="team-cate">
                <li class="t-cate" data-id="all"><a href="/cms/c/chanpinyufuw.html">全部</a></li>
                <?php $__0uiQ2lgWJ5__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>$__CHANNEL__['parent_id']]); if(is_array($__0uiQ2lgWJ5__) || $__0uiQ2lgWJ5__ instanceof \think\Collection || $__0uiQ2lgWJ5__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__0uiQ2lgWJ5__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                <li class="t-cate" data-id="<?php echo $channel['id']; ?>"><a href="<?php echo $channel['url']; ?>" class="<?php if($__CHANNEL__['id'] == $channel['id']): ?>c-red<?php endif; ?>"><?php echo $channel['name']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="conts" style="margin-top: 50px">
              <!--   <p class="title"><?php echo $__CHANNEL__['description']; ?></p> -->
                <ul class="p-items">
                     <?php $__rWxN9oqeFv__ = \addons\cms\model\Archives::getArchivesList(["id"=>"hot","orderby"=>"weigh","orderway"=>"asc","channel"=>$__CHANNEL__->id]); if(is_array($__rWxN9oqeFv__) || $__rWxN9oqeFv__ instanceof \think\Collection || $__rWxN9oqeFv__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__rWxN9oqeFv__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot): $mod = ($i % 2 );++$i;?>
                    <li>
                       <?php echo $hot['img']; ?>
                        <div class="p-heng"></div>
                        <a href="<?php echo $hot['url']; ?>" class="liaojie">了解更多</a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__bnOuWcqF6M__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__bnOuWcqF6M__) || $__bnOuWcqF6M__ instanceof \think\Collection || $__bnOuWcqF6M__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__bnOuWcqF6M__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__AcgkJtHwUj__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__AcgkJtHwUj__) || $__AcgkJtHwUj__ instanceof \think\Collection || $__AcgkJtHwUj__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__AcgkJtHwUj__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
