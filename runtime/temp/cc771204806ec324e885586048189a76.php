<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/default/tpadmin/addons/cms/view/default/page_telme.html";i:1551192142;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__cVZ2AQYRlO__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__cVZ2AQYRlO__) || $__cVZ2AQYRlO__ instanceof \think\Collection || $__cVZ2AQYRlO__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__cVZ2AQYRlO__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__rPJDtXNkK7__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__rPJDtXNkK7__) || $__rPJDtXNkK7__ instanceof \think\Collection || $__rPJDtXNkK7__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__rPJDtXNkK7__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__mjVXNDUHcJ__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__mjVXNDUHcJ__) || $__mjVXNDUHcJ__ instanceof \think\Collection || $__mjVXNDUHcJ__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__mjVXNDUHcJ__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
...
<link rel="stylesheet" href=" /assets/addons/cms/css/telMe.css?v=<?php echo \think\Config::get("site.version"); ?>">
<style type="text/css">
    body{
        background:#ffffff;
    }
...
<div class="cont-box">
    <div class="box-title">
        <h2><?php echo $__PAGE__['title']; ?></h2>
    </div>
    <div class="conts">
        <p class="title">长财咨询：<?php echo $config['dizhi']; ?></p>
        <div class="map" id="container" style="height:700px;">
    
        </div>
    </div>
    
</div>
<?php $configs = get_addon_config('address'); ?>
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=<?php echo (isset($configs['baidukey']) && ($configs['baidukey'] !== '')?$configs['baidukey']:''); ?>"></script>
 <script type="text/javascript">
    ...
    var new_point = new BMap.Point(<?php echo $configs['lng']; ?>,<?php echo $configs['lat']; ?>);
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__hCIn0e8S4E__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__hCIn0e8S4E__) || $__hCIn0e8S4E__ instanceof \think\Collection || $__hCIn0e8S4E__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__hCIn0e8S4E__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__eoSNbB3fgs__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__eoSNbB3fgs__) || $__eoSNbB3fgs__ instanceof \think\Collection || $__eoSNbB3fgs__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__eoSNbB3fgs__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
