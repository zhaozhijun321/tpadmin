<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/default/tpadmin/addons/cms/view/default/show_chanpinyufuwu.html";i:1550664100;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__5sZJGpL3a4__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__5sZJGpL3a4__) || $__5sZJGpL3a4__ instanceof \think\Collection || $__5sZJGpL3a4__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__5sZJGpL3a4__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__JfsVpc781b__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__JfsVpc781b__) || $__JfsVpc781b__ instanceof \think\Collection || $__JfsVpc781b__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__JfsVpc781b__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__6x3gBwR9pL__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__6x3gBwR9pL__) || $__6x3gBwR9pL__ instanceof \think\Collection || $__6x3gBwR9pL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__6x3gBwR9pL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
...
<div class="n-detail">
 ...
 <!-- 产品与服务 -->
        <div class="n-box-right">
            ...
            <div class="list">
                <!-- 右侧小分类 -->
                <?php $__IVEkg1QZut__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","row"=>"8","orderby"=>"weigh","orderway"=>"desc","channel"=>$__CHANNEL__->id]); if(is_array($__IVEkg1QZut__) || $__IVEkg1QZut__ instanceof \think\Collection || $__IVEkg1QZut__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__IVEkg1QZut__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($item['id']==$__ARCHIVES__->id): else: ?>
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__un02R8Cybi__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__un02R8Cybi__) || $__un02R8Cybi__ instanceof \think\Collection || $__un02R8Cybi__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__un02R8Cybi__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__YJ8iGsIo5f__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__YJ8iGsIo5f__) || $__YJ8iGsIo5f__ instanceof \think\Collection || $__YJ8iGsIo5f__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__YJ8iGsIo5f__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
