<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/www/wwwroot/default/tpadmin/addons/cms/view/default/index.html";i:1556431127;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__95BrxhEX4H__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__95BrxhEX4H__) || $__95BrxhEX4H__ instanceof \think\Collection || $__95BrxhEX4H__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__95BrxhEX4H__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__cG8peRNJuT__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__cG8peRNJuT__) || $__cG8peRNJuT__ instanceof \think\Collection || $__cG8peRNJuT__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__cG8peRNJuT__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__wb8Q6Bo2IO__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__wb8Q6Bo2IO__) || $__wb8Q6Bo2IO__ instanceof \think\Collection || $__wb8Q6Bo2IO__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__wb8Q6Bo2IO__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="swiper-container swiper-container1">
            <div class="swiper-wrapper">
                <?php $__c4Fvfn2JWM__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"focus","row"=>"5"]); if(is_array($__c4Fvfn2JWM__) || $__c4Fvfn2JWM__ instanceof \think\Collection || $__c4Fvfn2JWM__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__c4Fvfn2JWM__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
        ...
        <!-- 最近新闻 -->
        <div class="news-box">
            <?php $__yAkNZYaTUr__ = \addons\cms\model\Channel::getChannelList(["id"=>"xinwen","cache"=>"true","typeid"=>3]); if(is_array($__yAkNZYaTUr__) || $__yAkNZYaTUr__ instanceof \think\Collection || $__yAkNZYaTUr__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__yAkNZYaTUr__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xinwen): $mod = ($i % 2 );++$i;?>
            ...
            <div class="news-items">
                <?php $__27BnuvqczG__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","channel"=>"3,7,5,4","orderway"=>"desc","orderby"=>"publishtime","row"=>"4"]); if(is_array($__27BnuvqczG__) || $__27BnuvqczG__ instanceof \think\Collection || $__27BnuvqczG__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__27BnuvqczG__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
                <div class="item">
        ...
        <!-- 日历部分 -->
        <div class="date-box">
            <?php $__5HpFYMJjXf__ = \addons\cms\model\Channel::getChannelList(["id"=>"kecheng","cache"=>"true","typeid"=>97]); if(is_array($__5HpFYMJjXf__) || $__5HpFYMJjXf__ instanceof \think\Collection || $__5HpFYMJjXf__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__5HpFYMJjXf__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$kecheng): $mod = ($i % 2 );++$i;?>
        ...
        <!-- 关于我们 -->
        <div class="guanyu">
            <?php $__M03EnexZYc__ = \addons\cms\model\Channel::getChannelList(["id"=>"guanyu","cache"=>"true","typeid"=>73]); if(is_array($__M03EnexZYc__) || $__M03EnexZYc__ instanceof \think\Collection || $__M03EnexZYc__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__M03EnexZYc__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyu): $mod = ($i % 2 );++$i;?>
        ...
        <div class="product">
            <div class="p-box">
                    <?php $__ykYWUqhxJC__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","cache"=>"true","typeid"=>98]); if(is_array($__ykYWUqhxJC__) || $__ykYWUqhxJC__ instanceof \think\Collection || $__ykYWUqhxJC__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ykYWUqhxJC__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
        ...
        <div class="team">
            <div class="t-box">
                   <?php $__usGQ9pAogT__ = \addons\cms\model\Channel::getChannelList(["id"=>"zhuajia","cache"=>"true","typeid"=>63]); if(is_array($__usGQ9pAogT__) || $__usGQ9pAogT__ instanceof \think\Collection || $__usGQ9pAogT__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__usGQ9pAogT__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zhuajia): $mod = ($i % 2 );++$i;?>
       ...
       <div class="news-box todys" style="background: #fff">
            <?php $__DI6PL0FdQS__ = \addons\cms\model\Channel::getChannelList(["id"=>"jinri","cache"=>"true","typeid"=>92]); if(is_array($__DI6PL0FdQS__) || $__DI6PL0FdQS__ instanceof \think\Collection || $__DI6PL0FdQS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__DI6PL0FdQS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jinri): $mod = ($i % 2 );++$i;?>
            ...
            <div class="cates">
                <ul class="cate-group">
                    <?php $__CX3QRHkvZL__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","typeid"=>90,"type"=>"son","orderway"=>"asc","orderby"=>"weigh"]); if(is_array($__CX3QRHkvZL__) || $__CX3QRHkvZL__ instanceof \think\Collection || $__CX3QRHkvZL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__CX3QRHkvZL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
            ...
            <div class="news-items tody ">
                <?php $__Taebj2H8MG__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","row"=>"4","orderby"=>"publishtime","orderway"=>"desc","channel"=>92]); if(is_array($__Taebj2H8MG__) || $__Taebj2H8MG__ instanceof \think\Collection || $__Taebj2H8MG__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Taebj2H8MG__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <div class="item">
            ...
            <div class="news-items tody hide">
                 <?php $__jTMV8z6PsI__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","row"=>"4","orderby"=>"publishtime","orderway"=>"desc","channel"=>93]); if(is_array($__jTMV8z6PsI__) || $__jTMV8z6PsI__ instanceof \think\Collection || $__jTMV8z6PsI__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__jTMV8z6PsI__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <div class="item">
                    <a href="<?php echo $item['url']; ?>">
                       <?php echo $item['img']; ?>
                    </a>
            ...
            <!-- 长财猎头 -->
          <!--  <div class="news-items tody hide">
                <?php $__DdIaucmkwn__ = \addons\cms\model\Archives::getArchivesList(["id"=>"lietou","row"=>"4","orderby"=>"id","orderway"=>"desc","channel"=>94]); if(is_array($__DdIaucmkwn__) || $__DdIaucmkwn__ instanceof \think\Collection || $__DdIaucmkwn__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__DdIaucmkwn__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lietou): $mod = ($i % 2 );++$i;?>
                <div class="item">
        ...
        <div class="imgs-box">
            ...
            <div class="box" style="margin-top:80px;height: 365px;margin-bottom: 100px">
                <?php $__tTJac8UCuy__ = \addons\cms\model\Block::getBlockList(["id"=>"hezuoqiye","name"=>"hezuoqiye"]); if(is_array($__tTJac8UCuy__) || $__tTJac8UCuy__ instanceof \think\Collection || $__tTJac8UCuy__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__tTJac8UCuy__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hezuoqiye): $mod = ($i % 2 );++$i;?>
...
<script>
  ...
  var optionMap = {
    ...
    <?php $__bQWtTlcPLN__ = \addons\cms\model\Block::getBlockList(["id"=>"video","name"=>"video"]); if(is_array($__bQWtTlcPLN__) || $__bQWtTlcPLN__ instanceof \think\Collection || $__bQWtTlcPLN__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__bQWtTlcPLN__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): $mod = ($i % 2 );++$i;?>
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__GDRI1eMaP2__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__GDRI1eMaP2__) || $__GDRI1eMaP2__ instanceof \think\Collection || $__GDRI1eMaP2__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__GDRI1eMaP2__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__rGJH8CwEF0__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__rGJH8CwEF0__) || $__rGJH8CwEF0__ instanceof \think\Collection || $__rGJH8CwEF0__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__rGJH8CwEF0__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
