<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/formfield.html";i:1549411004;s:70:"/www/wwwroot/default/tpadmin/addons/cms/view/default/channel_yewu.html";i:1550912912;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;s:76:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/guanyu_list.html";i:1550912890;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__lZfdoRVODN__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__lZfdoRVODN__) || $__lZfdoRVODN__ instanceof \think\Collection || $__lZfdoRVODN__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__lZfdoRVODN__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__Be9IMkprSd__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__Be9IMkprSd__) || $__Be9IMkprSd__ instanceof \think\Collection || $__Be9IMkprSd__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Be9IMkprSd__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__eX0KdZ9hbB__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__eX0KdZ9hbB__) || $__eX0KdZ9hbB__ instanceof \think\Collection || $__eX0KdZ9hbB__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__eX0KdZ9hbB__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
    ...
    <link rel="stylesheet" href=" /assets/addons/cms/css/about.css?v=<?php echo \think\Config::get("site.version"); ?>">
       <div class="g-navs">
	<ul>
	   <?php $__mj6r4wiT0e__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","typeid"=>$__CHANNEL__['id'],"condition"=>"77<>id","type"=>"brother","orderway"=>"asc","ordery"=>"weigh"]); if(is_array($__mj6r4wiT0e__) || $__mj6r4wiT0e__ instanceof \think\Collection || $__mj6r4wiT0e__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__mj6r4wiT0e__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
        ...
        <!-- 长财业务 -->
        <div class="imgs-box  nav-item">
            <div class="box">
                <p>公司业务：财税整体解决方案咨询、财税专项咨询、激励系统整体解决方案咨询、专项咨询、企业商业咨询。</p>
                <img style="margin:30px 0" src=" /assets/addons/cms/src/image/Mask.png" alt="">
                <p>长财咨询全国滚动开设《财务系统班》，《激励系统班》集中咨询式方案班。以及《财务通》《管理层财务思维》，《资本通》等精品课程和大量陪伴计划课程。</p>
                <img style="margin:30px 0" src=" /assets/addons/cms/src/image/tixi.png" alt="">
                <p>旗下长猎公司负责为企业提供中高端猎头服务。<br> 长财咨询为企业提供从财务，税务，股权，绩效，薪酬，品牌，定位，商业模式咨询到资本投资，资本融资，企业上市等全方位的咨询服务。帮助企业管理升级，陪伴企业一起成长！</p>
            </div>
        </div>
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__JpPXFi3yv1__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__JpPXFi3yv1__) || $__JpPXFi3yv1__ instanceof \think\Collection || $__JpPXFi3yv1__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__JpPXFi3yv1__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__WeS5fycRnL__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__WeS5fycRnL__) || $__WeS5fycRnL__ instanceof \think\Collection || $__WeS5fycRnL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__WeS5fycRnL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
