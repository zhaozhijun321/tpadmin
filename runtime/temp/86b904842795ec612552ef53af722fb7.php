<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/formfield.html";i:1549411004;s:68:"/www/wwwroot/default/tpadmin/addons/cms/view/default/list_today.html";i:1556430551;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__tdZQiPLqlg__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__tdZQiPLqlg__) || $__tdZQiPLqlg__ instanceof \think\Collection || $__tdZQiPLqlg__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__tdZQiPLqlg__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__BJqFDeG7f6__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__BJqFDeG7f6__) || $__BJqFDeG7f6__ instanceof \think\Collection || $__BJqFDeG7f6__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__BJqFDeG7f6__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__CQamBzJgjP__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__CQamBzJgjP__) || $__CQamBzJgjP__ instanceof \think\Collection || $__CQamBzJgjP__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__CQamBzJgjP__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
 ...
 <div class="n-detail">
        <div class="n-box-left">
            <!-- <h2>最近新闻</h2> -->
            <ul class="to-title">
                <?php $__l58XKW6cVb__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>90,"orderway"=>"asc","orderby"=>"weigh"]); if(is_array($__l58XKW6cVb__) || $__l58XKW6cVb__ instanceof \think\Collection || $__l58XKW6cVb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__l58XKW6cVb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                <li class="<?php if($__CHANNEL__['id'] == $channel['id']): ?>c-red<?php endif; ?>" onclick="local('<?php echo $channel['url']; ?>')"><?php echo $channel['name']; ?></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
             <div class="items">
                <!-- 新闻小模块 -->
                 <?php $__DZzp4BaiC0__ = \addons\cms\model\Archives::getPageList($__PAGELIST__, ["id"=>"list","orderway"=>"desc","orderby"=>"publishtime"]); if(is_array($__DZzp4BaiC0__) || $__DZzp4BaiC0__ instanceof \think\Collection || $__DZzp4BaiC0__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__DZzp4BaiC0__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                <a href="<?php echo $list['url']; ?>">
                    <div class="item">
                        ...
                        <div class="cont">
                            ...
                            <p class="times"><?php echo date('Y-m-d',$list['publishtime']); ?></p>
                        </div>
                    </div>
                </a>
                <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="n-box-right rg-news">
            ...
            <div class="r-items">
                <!-- 右侧小分类 -->
                 <?php $__UGwtdNzm4S__ = \addons\cms\model\Archives::getPageList($__PAGELIST__, ["id"=>"hot","row"=>"7","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__UGwtdNzm4S__) || $__UGwtdNzm4S__ instanceof \think\Collection || $__UGwtdNzm4S__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__UGwtdNzm4S__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot): $mod = ($i % 2 );++$i;?>
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__dCmIZbruTv__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__dCmIZbruTv__) || $__dCmIZbruTv__ instanceof \think\Collection || $__dCmIZbruTv__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__dCmIZbruTv__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__ZqoVGj2x4u__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__ZqoVGj2x4u__) || $__ZqoVGj2x4u__ instanceof \think\Collection || $__ZqoVGj2x4u__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ZqoVGj2x4u__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
