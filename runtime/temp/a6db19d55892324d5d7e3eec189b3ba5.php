<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/formfield.html";i:1549411004;s:76:"/www/wwwroot/default/tpadmin/addons/cms/view/default/channel_jiaruwomen.html";i:1550912910;s:71:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/layout.html";i:1555567574;s:76:"/www/wwwroot/default/tpadmin/addons/cms/view/default/common/guanyu_list.html";i:1550912890;}*/ ?>
<!-- 长财咨询官网首页页面代码 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
            ...
            <div class="t-navs">
                ...
                <ul class="navs-con">
                    <li class="nav <?php if(request()->controller() == 'index'): ?>unders<?php endif; ?>">
                     ...
                     <?php $__8VbcMzsDZF__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","typeid"=>"98,72,63","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__8VbcMzsDZF__) || $__8VbcMzsDZF__ instanceof \think\Collection || $__8VbcMzsDZF__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__8VbcMzsDZF__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        ...
        <?php if(request()->controller() != 'index' && request()->controller() != 'page'): if(request()->controller() != 'archives'): if(in_array($__CHANNEL__['id'],[72,98,63]) or in_array($__CHANNEL__['parent_id'],[72,98,63])): else: ?>
            <div class="crumbs">
                当前位置：
                <?php $__psYmcW4FNk__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__psYmcW4FNk__) || $__psYmcW4FNk__ instanceof \think\Collection || $__psYmcW4FNk__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__psYmcW4FNk__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
         ...
         <div class="crumbs">
                当前位置：
                <?php $__XUW86PGVu0__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__XUW86PGVu0__) || $__XUW86PGVu0__ instanceof \think\Collection || $__XUW86PGVu0__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__XUW86PGVu0__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key==0): ?>
                <span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php else: ?>
                 -<span onclick="local('<?php echo $item['url']; ?>')"><?php echo $item['name']; ?></span>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
    ...
    <link rel="stylesheet" href=" /assets/addons/cms/css/about.css?v=<?php echo \think\Config::get("site.version"); ?>">
        <div class="g-navs">
	<ul>
	   <?php $__8mubhRIH2Y__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","typeid"=>$__CHANNEL__['id'],"condition"=>"77<>id","type"=>"brother","orderway"=>"asc","ordery"=>"weigh"]); if(is_array($__8mubhRIH2Y__) || $__8mubhRIH2Y__ instanceof \think\Collection || $__8mubhRIH2Y__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__8mubhRIH2Y__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
        ...
        <!-- 加入我们 -->
        <div class="joins nav-item">
            <div class="cont">
                <!-- 里面为富文本返回数据 -->
                <?php echo $__CHANNEL__['description']; ?>
            </div>
        </div>
        ...
        <div class="com-bottom">
            <div class="bot-box">
                ...
                <ul style="width:312px;">
                    ...
                    <?php $__owvgVn2mSE__ = \addons\cms\model\Channel::getChannelList(["type"=>"son","id"=>"guanyuzi","typeid"=>72,"model"=>6,"orderway"=>"asc"]); if(is_array($__owvgVn2mSE__) || $__owvgVn2mSE__ instanceof \think\Collection || $__owvgVn2mSE__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__owvgVn2mSE__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanyuzi): $mod = ($i % 2 );++$i;?>
                    <li class="detail-name"><a href="<?php echo $guanyuzi['url']; ?>"  ><?php echo $guanyuzi['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <ul style="width:220px;">
                    <h5 class="title">产品与服务</h5>
                     <?php $__jFPzviMxGr__ = \addons\cms\model\Channel::getChannelList(["id"=>"chanpinzi","type"=>"son","orderway"=>"asc","ordery"=>"weigh","typeid"=>98]); if(is_array($__jFPzviMxGr__) || $__jFPzviMxGr__ instanceof \think\Collection || $__jFPzviMxGr__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__jFPzviMxGr__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chanpinzi): $mod = ($i % 2 );++$i;?>
